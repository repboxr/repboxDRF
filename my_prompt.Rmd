...
I feel that currently these tab commands in Stata might not be part of the repboxDRF pipeline. Is my guess correct?

tab caste, gen(castedum)
tab msgX_survcode, gen(msgX_survcodedum)

Yet such tab commands with gen option do generate data and need to be included. How to add them? We can also add all tab commands, if checking for gen option is to complicated.

Without gen option, does tab not modify the data set in Stata? 

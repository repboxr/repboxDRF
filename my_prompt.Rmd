...
drf_is_cache_safe = function(path_df, c_runid, dep_df=drf$dep_df, drf) {
  restore.point("drf_is_cache_safe")
  ...
  for (i in seq_along(pids)) {
    ...
    if (length(path_caches) > 0) {
      ...
      for (c_runid in path_caches) {
        if (drf_is_cache_safe(pdf, c_runid, dep_df=drf$dep_df)) {
...
Can you check whether the current cache handling is consistent with the notes below? Where are deviations / unclear cache handling in code?
